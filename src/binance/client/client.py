...
class Client:
    ...
    def load(self):
        infos = self.fetch_exchange_info()
    ...
    def ping(self):
        return self.http.send_api_call("/api/v3/ping", send_api_key=False)

    # https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md#check-server-time
    def fetch_server_time(self):
        return self.http.send_api_call("/api/v3/time", send_api_key=False)

    # https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md#exchange-information
    def fetch_exchange_info(self):
        return self.http.send_api_call("/api/v3/exchangeInfo", send_api_key=False)
    ...
    def fetch_order_book(self, symbol, limit=100):
        ...
        if limit == 100:
            return self.http.send_api_call(
    ...
    def fetch_recent_trades_list(self, symbol, limit=500):
        self.assert_symbol(symbol)
        if limit == 500:
    ...
    def fetch_old_trades_list(self, symbol, from_id=None, limit=500):
        self.assert_symbol(symbol)
        if limit == 500:
            params = {"symbol": symbol}
        elif limit > 0 and limit < 1000:
    ...
    def fetch_aggregate_trades_list(
    ...
    def fetch_average_price(self, symbol):
        self.assert_symbol(symbol)
        return self.http.send_api_call(
            "/api/v3/avgPrice",
            params={"symbol": symbol},
    ...
    def fetch_ticker_price_change_statistics(self, symbol=None):
        if symbol:
            self.assert_symbol_exists(symbol)
        return self.http.send_api_call(
            "/api/v3/avgPrice",
    ...
    def fetch_24_hour_stats(self, symbol=None):
        if symbol:
            self.assert_symbol_exists(symbol)
        return self.http.send_api_call(
            "/api/v3/ticker/24hr",
    ...
    # todo port rest of async function when I need them
    ...
    def fetch_account_information(self, receive_window=None):
        params = {}
